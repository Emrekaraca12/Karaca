#tools.py: Bu dosya, SQL sorgularını depolayan işlevleri içerir.
# Bu sorgular, veritabanına erişmek için kullanılır ve işlevlerin ve prosedürlerin düzgün çalışmasını sağlar.
def insert_data():
    return '''
