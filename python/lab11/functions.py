#function.py: Bu dosya, bir dizi işlev ve saklı işlev tanımlar. Her biri, bir desene
# göre kayıtları döndüren bir işlev, yeni bir kullanıcı ekleyen veya var olan bir kullanıcının
# telefon numarasını güncelleyen bir prosedür, veri tabanından sayfalama ile veri çeken
# bir işlev ve kullanıcı adına veya telefon numarasına göre verileri silen bir prosedür tanımlar.
import psycopg2
