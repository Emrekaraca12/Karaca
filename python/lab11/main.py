#main.py: Bu dosya, veritabanına veri eklemek, güncellemek, silmek ve sorgulamak için 
#çeşitli işlevleri kullanır. Ayrıca, bir dizi sorguyu sınamak için bazı örnek kodları içerir.
